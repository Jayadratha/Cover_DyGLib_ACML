...
if __name__ == "__main__":
    ...
    # logger.info(f'save node classification results at {save_result_path_all} for all {args.num_runs} runs')
        ...
        save_result_folder = f"./saved_results/{args.model_name}/{args.dataset_name}/lr_{args.learning_rate}/cov_{args.coverage}"
        os.makedirs(save_result_folder, exist_ok=True)
        save_result_path = os.path.join(save_result_folder, f"{args.load_model_name}_evaluation.json")
    ...
    save_result_folder = f"./saved_results/{args.model_name}/{args.dataset_name}/lr_{args.learning_rate}/cov_{args.coverage}"
    os.makedirs(save_result_folder, exist_ok=True)
    save_result_path = os.path.join(save_result_folder, f"{args.load_model_name}_all_{args.num_runs}_runs_evaluation.json")
