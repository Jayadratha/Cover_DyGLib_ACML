...
def cls_agnostic_get_node_classification_args_cvr_based():
    """
...
def cls_specific_get_node_classification_args_cvr_based():
    """
    get the args for the node classification task
    :return:
    """
    ...
    parser.add_argument('--cls_1_wgt', type=float, default=100.0, help='majority class weight w.r.t. minority class') # hyperparameter for class weight
...
def get_node_classification_args_cwr_based():
    """
    get the args for the node classification task
    :return:
    """
    ...
    parser.add_argument('--test_interval_epochs', type=int, default=10, help='how many epochs to perform testing once')
    parser.add_argument('--load_best_configs', action='store_true', default=False, help='whether to load the best configurations')
    parser.add_argument('--loss', type=str, default="CwRLoss", choices=["CwRLoss", "CwRLoss_mod"], help='Loss function')
    parser.add_argument('--cost', type=float, default=0.8, help='cost')
    parser.add_argument('--gamma', type=float, default=None, help='gamma for the focal loss')
...
def get_node_classification_args_abl_beta():
    """
    get the args for the node classification task
    :return:
    """
    ...
    parser.add_argument('--alphaloss', type=float, default=0.5, help='Alpha') # hyperparameter alpha for overall loss function
    parser.add_argument('--gamma', type=float, default=None, help='gamma for the focal loss')
    parser.add_argument('--cls_1_wgt', type=float, default=100, help='cls_1_wgt')
