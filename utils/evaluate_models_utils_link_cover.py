...
# .squeeze(dim=-1)
            ...
            # pos_mask = all_eval_positive_sel_preds >= 0.5
            ...
            # neg_mask = all_eval_negative_sel_preds >= 0.5
...
# ############################################### AUC #######################################################
# auc_roc = roc_auc_score(selected_labels, selected_embeddings)
# # print("AUC ROC: {:.4f}".format(auc_roc))
# # Plot the ROC curve 
# fpr, tpr, thresholds = roc_curve(selected_labels, selected_embeddings)
# threshold = thresholds[np.argmax(tpr - fpr)]
# # threshold = thresholds[75]
# # print("threshold: ", threshold)
# # print("best threshold index: ", np.argmax(tpr - fpr))
# predicted_classes = (selected_embeddings >= threshold).astype(int)
# ############################################### accuracy #######################################################
# accuracy = accuracy_score(selected_labels, predicted_classes)
# ############################################### classification_report #######################################################
# if epoch=="test":
#     print("*"*70)
#     print("taken threshold index: ", np.argmax(thresholds == threshold))
#     target_names = ['cls 0 (can edit)', 'cls 1 (banned)']
#     print(classification_report(selected_labels, predicted_classes, target_names=target_names))
#     cnt_0 = len(predicted_classes) - np.count_nonzero(predicted_classes)  # Count of 0s
#     cnt_1 = np.count_nonzero(predicted_classes)  # Count of 1s
#     print(f"count predicted classes: cnt_0_{cnt_0}, cnt_1_{cnt_1}")
#     # Count of 0s and 1s
#     count_0 = len(selected_labels) - np.count_nonzero(selected_labels)  # Count of 0s
#     count_1 = np.count_nonzero(selected_labels)  # Count of 1s    
#     print(f"count selected actual labels: count_0_{count_0}, count_1_{count_1}")
#     print("\n")
#     print("threshold for classification: ", threshold)
#     print("threshold for coverage: ", t)
#     print("\n")
