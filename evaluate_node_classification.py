...
from models.modules_orig import MLPClassifier
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        save_result_path = os.path.join(save_result_folder, f"{args.save_result_name}_lr{args.learning_rate}_orig_100_cov_eval.json")
...
# INFO:root:test roc_auc, [0.8139095497538048, 0.8781082873524659, 0.8206707615665498, 0.8946671833489495, 0.8682267386937194]
# INFO:root:average test roc_auc, 0.8551 ± 0.0359