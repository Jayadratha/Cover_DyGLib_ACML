...
from models.MemoryModel_link_cover import MemoryModel, compute_src_dst_node_time_shifts
...
if __name__ == "__main__":
    ...
    # get arguments
    args = get_link_prediction_args_cvr_based(is_evaluation=False)
    ...
    for run in range(args.num_runs):
        ...
        os.makedirs(f"./logs/{args.model_name}/{args.dataset_name}/{args.save_model_name}/lr_{args.learning_rate}/link_cov_{args.coverage}/", exist_ok=True)
        # create file handler that logs debug and higher level messages
        fh = logging.FileHandler(f"./logs/{args.model_name}/{args.dataset_name}/{args.save_model_name}/lr_{args.learning_rate}/link_cov_{args.coverage}/{str(time.time())}.log")
        ...
        save_model_folder = f"./saved_models/{args.model_name}/{args.dataset_name}/{args.save_model_name}/lr_{args.learning_rate}/link_cov_{args.coverage}/"
...
# .squeeze(dim=-1)
                ...
                if args.coverage == 1.0:
                    ...
                    loss_1 = sel_loss(predicts, sel_head_predicts, labels, coverage=args.coverage)
